  ...
  "artifacts/n64/mupen64plus-web-1.5.7-baseline/index.7f0ebbf78c.cjs"(exports, module) {
    ...
    var createModule2 = (() => {
      ...
      return function(createModule3) {
        ...
        function _endStats(numberOfRecompiles, rspMs, dlistMs, rdpMs, presentMs, audioMs, triangleDrawMs, rectDrawMs, trianglePrepareMs, triangleUploadMs, triangleSubmitMs, triangleRestoreMs, triangleDrawCalls, rectDrawCalls, audioUnderruns) {
          if (Module2.endStats) {
            Module2.endStats(numberOfRecompiles, rspMs, dlistMs, rdpMs, presentMs, audioMs, triangleDrawMs, rectDrawMs, trianglePrepareMs, triangleUploadMs, triangleSubmitMs, triangleRestoreMs, triangleDrawCalls, rectDrawCalls, audioUnderruns);
          }
        }
